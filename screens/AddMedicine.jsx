  ...
  export const AddMedicine = ({navigation}) => {
    ...
    const handleSave = () => {
      ...
      if (!medicineName.trim()) {
        alert('Ingresá el nombre del medicamento');
        return;
      }
        ...
        <View style={addMedicineStyles.inputArea}>
          ...
          <View style={addMedicineStyles.optionPickerArea}>
            <View style={{ marginBottom: 30 }}>
              <Text style={Res.CommonStyles.texts.subtitle}>Medicamento</Text>
              <TextField
            ...
            <View style={{ marginBottom: 40 }}>
              <Text style={Res.CommonStyles.texts.subtitle}>Dosis</Text>
              <TextField
